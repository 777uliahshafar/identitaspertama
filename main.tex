...
\begin{abstract}
	...
	Elemen ini  termasuk aksesibilitas, kualitas visual, kenyamanan, keunikan, keterbacaan, dan rasa memiliki yang kuat terhadap tempat tersebut, derajat ketertutupan, legibilitas, aktivitas utama, dan daya tarik. Aspek tersebut diwakilkan oleh desain fisik yang menyebabkan perubahan pada identitas ruang publik tepi laut.

	% 	Hasil penelitian menunjukkan bahwa elemen-elemen fisik pada ruang publik ini belum cukup kuat dalam mempertahankan identitas ruang publik tepi laut ini.
	%     Kurangnya aksesibilitas, rendahnya keterbacaan, degradasi lingkungan perairan, dan keterhubungan ruang publik yang terbatas mengurangi kualitas hubungan dengan lingkungan sekitar.
	% Oleh karena itu, perlu dilakukan perbaikan dan peningkatan pada elemen-elemen fisik tersebut agar ruang publik tepi laut ini dapat lebih berinteraksi dengan lingkungan sekitar secara optimal.
	% 	Beberapa diantaranya adalah aksesibilitas dan keterbacaan yang buruk
	% 	Hasil penelitian menunjukkan sejumlah elemen fisik yang tergerus sehingga menyebabkan
	% 	aksesibilitas dan keterbacaan yang buruk, penurunan kualitas lingkungan perairan, serta kurangnya keterhubungan visual dan fungsional antara ruang publik dengan kawasan sekitarnya.
	% 	Aksesibilitas dan keterbacaan yang buruk, penurunan kualitas lingkungan perairan, serta kurangnya keterhubungan visual dan fungsional antara ruang publik dengan kawasan sekitarnya.
