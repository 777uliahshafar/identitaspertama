...
\begin{abstract}
	Penelitian ini bertujuan untuk memahami identitas tepi laut Jalan Mattirotasi (Matras) di Kota Parepare, dengan fokus pada aspek-aspek spesifik seperti bentuk fisik, aktivitas, dan makna. Hasil penelitian ini diharapkan dapat memberikan kontribusi dalam merancang dan merencanakan ruang publik yang lebih efektif dan berkesan di masa depan. Sebagai bagian dari upaya untuk memahami identitas ruang publik, penelitian ini menggali lebih dalam tentang bagaimana bentuk fisik, aktivitas, dan makna saling berinteraksi untuk membentuk karakter unik dari ruang-ruang tersebut. Metode penelitian yang diterapkan melibatkan pendekatan kualitatif. Penelitian berfokus pada studi kasus tunggal untuk mengumpulkan data tentang fenomena terkait bentuk fisik, aktivitas, dan makna yang kemudian disebut sebagai aspek ruang. Pengumpulan data dilakukan melalui observasi langsung, kemudian data dianalisis berdasarkan studi literatur. Kawasan yang dipilih sebagai studi kasus adalah tepi laut Mattirotasi. Hasil penelitian menunjukkan sejumlah aspek ruang yang tergerus sehingga menyebabkan aksesibilitas dan keterbacaan yang buruk, penurunan kualitas lingkungan perairan, serta kurangnya keterhubungan visual dan fungsional antara ruang publik dengan kawasan sekitarnya. Aspek-aspek tersebut termasuk aksesibilitas, kualitas visual, kenyamanan, keunikan, keterbacaan, dan rasa memiliki yang kuat terhadap tempat tersebut, derajat ketertutupan, legibilitas, aktivitas utama, dan daya tarik. Aspek tersebut diwakilkan oleh desain fisik yang menyebabkan perubahan pada identitas ruang publik tepi laut.
\end{abstract}

\hspace*{3.6mm}\textit{Kata Kunci:} Tepi laut, Identitas Tempat, Mattirotasi, Aspek Identitas % Keywords
